    ...
    async function loadJournalData() {
      ...
      try {
        ...
        if (!foundJournal) {
          ...
          if (foundJournal.OA_Homepage) {
            try {
              const url = new URL(foundJournal.OA_Homepage)
      ...
      <div className="min-h-screen bg-background">
        <div className="max-w-4xl mx-auto px-4 py-12">
          ...
          <div className="text-center py-20">
            ...
            <p className="text-muted-foreground">{error || "The requested journal could not be found."}</p>
          </div>
        </div>
      </div>
    )
